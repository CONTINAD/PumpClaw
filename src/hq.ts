...
<div class="rail">
  ...
  <nav>
    <a href="/">HQ</a><a href="/live">Live</a><a href="/calls">Calls</a><a href="/features">Features</a><a href="/filters">Filters</a><a href="/shadow">Strategies</a><a href="/sweep">Sweep</a><a href="/tasks">Tasks</a><a href="/strategies">Lab</a>
...
<div class="wrap">
  ...
  <div class="cols">
    ...
    <b class="ic">promising</b> = trending that way · <b class="warnc">tail-driven</b> = profit comes from 1–3 lucky trades · <b>thin</b> = under 15 trades.</div>
      ...
      <div class="panel" style="border-color:rgba(61,255,158,.28)">
        <h2 style="color:var(--phos)">◆ Real Money <a href="/live">FULL LOG →</a></h2>
        <div class="body flush" id="realmoney"><div class="empty">loading…</div></div>
      </div>
      <div class="panel">
