...
export const CONFIG = {
  ...
  // Share of sampled holders sitting in one connected funding component before the
  // set is treated as one operator. This is the bubble-map number: hub and peer-link
